...
public class UnifiedGenotyperIndelCallingIntegrationTest extends WalkerTest {
    ...
    public void testWithIndelAllelesPassedIn1() {
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("aa56ed44e77162efce45c936c485769e"));
    ...
    public void testWithIndelAllelesPassedIn2() {
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                baseCommandIndels + " --output_mode EMIT_ALL_SITES --genotyping_mode GENOTYPE_GIVEN_ALLELES -alleles "
                        ...
                        "pilot2_daughters.chr20.10k-11k.bam -o %s -L 20:10,000,000-10,100,000", 1,
                Collections.singletonList("a4b6434c59c4b119e480ddafc86de234"));
    ...
    public void testMultiSampleIndels1() {
        ...
        WalkerTest.WalkerTestSpec spec2 = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("f9d848fe5e6e6762e0dd5b5d925f74f4"));
    ...
    public void testGGAwithNoEvidenceInReads() {
        ...
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("41aa49e9c15198a006a1bc8e9638d6ec"));
    ...
    public void testMinIndelFraction0() {
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("2a82d1586b2148e8d902da5cf8538210"));
    ...
    public void testMinIndelFraction25() {
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("3184a3f58b3aeafcd97280af708a04bb"));
    ...
    public void testMinIndelFraction100() {
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                ...
                Collections.singletonList("990b838ef13b8ccf257eb6cbcc7c7741"));
